...
## Installation
If you want to use git control, you may need install `@dr.pogodin/react-native-fs` and `isomorphic-git`

`yarn add @dr.pogodin/react-native-fs && yarn add isomorphic-git`
